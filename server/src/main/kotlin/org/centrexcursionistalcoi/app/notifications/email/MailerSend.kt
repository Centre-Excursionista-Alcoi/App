...
import org.centrexcursionistalcoi.app.notifications.email.mailersend.SendMailRequest

object MailerSend : EmailProvider {
    ...
    override val isConfigured: Boolean get() = try {
    ...
    override suspend fun sendEmail(to: List<MailerSendEmail>, subject: String, htmlContent: String, attachments: List<MailerSendAttachment>?) {
        try {
            NotificationsConfig.mailerSendToken
        } catch (_: IllegalStateException) {
